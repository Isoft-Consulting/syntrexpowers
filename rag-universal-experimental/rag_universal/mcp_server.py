            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "economy": {
                        "type": ["boolean", "null"],
                        "default": None,
                        "description": "Override search budget mode for token economy. Null/omitted uses search.default_budget from rag.config.json.",
                    },
                    "auto_reindex": {
                        "type": "boolean",
...
def call_tool(name: str, arguments: dict[str, Any], root: str | None, config: str | None) -> Any:
    if name == "rag_search":
        ...
        economy = arguments.get("economy", None)
        return text_content(
            search_fn(
                root,
                config,
