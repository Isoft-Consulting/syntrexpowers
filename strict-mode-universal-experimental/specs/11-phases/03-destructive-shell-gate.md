...
- Previous-turn baseline evidence snapshots, plus expiry sweep for bypasses and pending opt-out approvals, are still incomplete. Those pieces must land before Phase 3 can be marked fully enforcing-ready across both providers.
